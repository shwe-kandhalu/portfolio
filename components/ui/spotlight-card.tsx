...
interface GlowCardProps {
  children: ReactNode;
  className?: string;
  glowColor?: "blue" | "purple" | "green" | "red" | "orange" | "rose" | "teal";
  size?: "sm" | "md" | "lg";
  width?: string | number;
...
const glowColorMap = {
  ...
  rose:   { base: 350, spread: 150 },
  teal:   { base: 180, spread: 180 },
};
...
const GlowCard: React.FC<GlowCardProps> = ({
  ...
  return (
    <>
      ...
      >
        <div data-glow />
        {/* Inner wrapper clips content to rounded corners without clipping the glow border */}
        <div className="relative z-10 overflow-hidden rounded-[13px] h-full flex flex-col">
          {children}
        </div>
      </div>
    </>
